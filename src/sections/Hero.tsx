...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative h-2/3 overflow-hidden -mt-[88px] pt-[88px] xl:h-[80svh]">
      {/* 데스크톱 배경 이미지 - 최적화된 로딩 */}
      ...
      {/* 메인 콘텐츠 */}
      <Container className="relative z-10 ml-5 pb-8 xl:ml-14 flex items-start justify-start h-42/5 pt-6 xl:pt-28">
